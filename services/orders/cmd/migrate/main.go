...
import (
	...
	"goshop/services/orders/migrations"
)

func main() {
	dirFlag := flag.String("dir", "services/orders/migrations", "path to migrations directory (used for create)")
	...
	goose.SetTableName("schema_migrations_orders")
	...
	const lockKey = "orders_migrations"
